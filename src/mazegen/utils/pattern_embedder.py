...
def get_pattern_cells(width: int, height: int,
                      pattern: List[List[int]] = PATTERN_42,
    ...
    offset_x, offset_y = center_x - pattern_width // 2, \
...
def is_pattern_cell(
        x: int, y: int, pattern_cells: Set[Tuple[int, int]]) -> bool:
    """
